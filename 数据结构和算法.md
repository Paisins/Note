...
class BST:
    ...
    def delete(self, node):
        ...
        # 获取父结点
        father = node.father
        if node.left is None and node.left:
            # 判断被删除结点是父结点的左子树还是右子树
            # 左子树就给父结点的左子树，右子树就给右子树
        elif node.left and node.left is None:
            # 判断被删除结点是父结点的左子树还是右子树
            # 左子树就给父结点的左子树，右子树就给右子树
